...
/**
 * Objeto BarraSuperior
 * 
 * Elemento barra superior (header) para a GUI do sistema de loja de brinquedos.
 * 
...
public class BarraSuperior extends JPanel{
	/**
	 * Parametros uteis para uma barra superior.
	 * */
    private BarraMenu barraMenu;
    
    /**
     * Construtor padrao de BarraSuperior
     * */
    BarraSuperior(){
